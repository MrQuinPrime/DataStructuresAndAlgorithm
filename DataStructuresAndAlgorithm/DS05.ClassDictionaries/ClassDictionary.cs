...
{
    public class ClassDictionary:IDictionary
    {
        private DictionaryEntry[] items; //元素集合
        private Int32 ItemsInUse = 0;

        public ClassDictionary(Int32 numItems)
        {
        ...
        private class ClassDictionaryEnumerator : IDictionaryEnumerator
        {
            DictionaryEntry[] items;
            Int32 index = -1;

            public ClassDictionaryEnumerator(ClassDictionary sd)
            {
        ...
        {
            //  构造并返回一个枚举子
            return new ClassDictionaryEnumerator(this);
        }
        #endregion
